...
a persistence unit "Sistema-TransaccionalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Sistema-Transaccional\pom.xml":
...
artifact ("Sistema-Transaccional.war") is already built. You can build
